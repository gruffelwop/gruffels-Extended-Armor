...
public class ModItems {
    ...
    public static final Item CRIMSON_STEM_HELMET = registerItem("crimson_stem_helmet", new ArmorItem(ModArmorMaterials.CRIMSON_STEM, EquipmentSlot.HEAD, new FabricItemSettings().group(ModItemGroups.CREATIVE_TAB)));
    public static final Item CRIMSON_STEM_CHESTPLATE = registerItem("crimson_stem_chestplate", new ArmorItem(ModArmorMaterials.CRIMSON_STEM, EquipmentSlot.CHEST, new FabricItemSettings().group(ModItemGroups.CREATIVE_TAB)));
    public static final Item CRIMSON_STEM_LEGGINGS = registerItem("crimson_stem_leggings", new ArmorItem(ModArmorMaterials.CRIMSON_STEM, EquipmentSlot.LEGS, new FabricItemSettings().group(ModItemGroups.CREATIVE_TAB)));
    public static final Item CRIMSON_STEM_BOOTS = registerItem("crimson_stem_boots", new ArmorItem(ModArmorMaterials.CRIMSON_STEM, EquipmentSlot.FEET, new FabricItemSettings().group(ModItemGroups.CREATIVE_TAB)));
